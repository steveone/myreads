...
//function used to add items from search to bookshelf if a user selects a shelf
//      to put it on
...
//handle a user moving a bookshelf from one shelf to another
changeBookShelf = (book,shelf) => {
  ...
  //when the book display mounts, get all books currently on shelfs for display
  ...
  render() {
    return (
      <div className="app">
        ...
        {
          //handle default route but only on exact match
        }
